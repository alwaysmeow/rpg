...
from game.component.stats import Health, Mana, Stamina
from game.core.event import UseResourceEvent, ResourceRestoreEvent
...
class ResourceSystem(System):
    ...
    def resource_restore(self, entity_id, resource):
        result = {}
        ...
        for resource_type in resource:
            ...
            if resource_component:
                ...
                result[resource_type] = int(resource_component.value - old_value)
        
        return ResourceRestoreEvent(entity_id, result)
